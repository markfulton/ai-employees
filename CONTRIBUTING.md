...
- **Employee proposals.** A ninth role. Use the employee request template. Read `docs/HOW-EMPLOYEES-WORK.md` first, because a proposal that keeps the two stops and the schedule model is one I can build on.
- **Harness notes.** If you ran a kit on OpenClaw, Hermes, OpenCode, Codex, Antigravity, or on a Mac through launchd, tell me exactly what worked and what did not. `docs/HARNESSES.md` marks what I have tested myself and what I have not, and your report is what moves a row from untested to tested.
- **Show and tell.** Post what an employee did for your business in Discussions under Show and tell. Good ones go into the README's Employee of the Week series, with your name on them.
...
3. **The two stops are not negotiable.** A change that lets a routine send, spend, submit, publish, enter a credential, or write a secret is closed without discussion. A change that widens what a routine may do without asking, inside its own folder, is welcome.
