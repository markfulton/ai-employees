...
- A surface the platform terms rule retired, under `## Watchlist changes`: `- ngừng theo dõi «surface», điều khoản của nền tảng không cho đọc tự động; anh/chị hoặc người trực vẫn có thể tự mở xem rồi ghi vào market/manual.md`.
